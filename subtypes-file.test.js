...
const { checkJsonSchema, getAjv, isObject, normalizeString, getSubtypeSchemas } = require('./testHelpers');

test("File for subtype schemas", async () => {
	let fileContent = await getSubtypeSchemas(true);
	let schema;
	try {
